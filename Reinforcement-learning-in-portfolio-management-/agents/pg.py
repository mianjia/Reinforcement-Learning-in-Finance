...
#                 checkpoint = tf.train.get_checkpoint_state('./result_new/PG/'+self.number+'/'+'saved_network/'+type+'/')
    ...
    # 建立 policy gradient 神经网络 (有改变) - Establish policy gradient neural network (with changes)
    def build_net(self):
